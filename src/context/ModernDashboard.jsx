...
const ModernDashboard = () => {
  ...
  const recentActivity = [
    { type: "House Rent", amount: "-2,500", time: "Just now" },
    { type: "Salary", amount: "+15,000", time: "2 hours ago" },
    { type: "Car Expense", amount: "-350", time: "5 hours ago" },
    { type: "Transfer", amount: "-1,200", time: "Yesterday" }
  ];
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {stats.map((stat, index) => (
              <div key={index} className="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
