...
const MobileNavigation = () => {
  ...
  const navigationItems = [
    ...
    { path: '/add-trade', label: 'Add Trade', icon: '➕', description: 'Record new trade', isSpecial: true },
    { path: '/trades', label: 'All Trades', icon: '📋', description: 'View trade history' },
    { path: '/analytics', label: 'Analytics', icon: '📊', description: 'Performance insights' },
    { path: '/player-search', label: 'Player Search', icon: '🔍', description: 'Find players to trade' },
    ...
    <>
      ...
      >
        <div className="relative w-4 h-4">
          ...
          />
          <span
            className={`absolute h-0.5 w-4 bg-current transform transition-all duration-300 top-1.5 ${
      ...
      {/* Slide Menu */}
      <div
        className={`fixed top-0 left-0 h-full w-72 bg-white dark:bg-gray-900 shadow-2xl z-50 transform transition-transform duration-300 ease-out overflow-hidden ${
      ...
      >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`font-medium text-sm truncate ${isSpecial ? 'text-white' : ''}`}>{label}</p>
                    <p
                  ...
                  {/* Active Indicator */}
                  {active && !isSpecial && <div className="w-1.5 h-1.5 bg-purple-600 dark:bg-purple-400 rounded-full" />}
                </Link>
              );
            })}
          </nav>
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-700">
          <div className="bg-gray-50 dark:bg-gray-8 00 rounded-xl p-3 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-3">
