...
borderRadius: 24,
overflow: “hidden”,
background: `radial-gradient(ellipse at center, rgba(6,95,70,0.25), rgba(2,44,34,0.15) 70%), linear-gradient(180deg,  rgba(6,95,70,0.18) 0%,  rgba(4,120,87,0.12) 25%, rgba(6,95,70,0.08) 50%,  rgba(4,120,87,0.12) 75%, rgba(6,95,70,0.18) 100%)`,
border: “2px solid rgba(6,95,70,0.4)”,
boxShadow: `0 8px 32px rgba(0,0,0,0.4), inset 0 0 0 1px rgba(34,197,94,0.1), inset 0 1px 0 rgba(255,255,255,0.05)`,
};
