...
const DesktopSidebar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v7a2 2 0 01-2 2h-2m-10 0H5a2 2 0 01-2-2v-7a2 2 0 012-2h2m3-4h4a2 2 0 012 2v1H8V6a2 2 0 012-2z" />
        </svg>
      ),
    },
    {
